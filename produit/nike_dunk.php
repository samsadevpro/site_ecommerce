    ...
    <!-- ################## -->
        ...
        <section class="product-detail">
            <div class="product-images">
                <img src="../images/nike/dunk.png.webp" width=300 height=30% alt="T-Shirt 12A">
            </div>
            ...
            <div class="product-info">
                ...
                <p class="description">
                    Cette Dunk de la collection "12A" offre confort et style. Fabriqué à partir de coton 100% de haute qualité, il est idéal pour un usage quotidien.
                </p>
